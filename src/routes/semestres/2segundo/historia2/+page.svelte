<article id="mainarticle">
	...
	<section>
		...
		<ol class="orderedlist">
			...
			<li>Gobierno de Carlos Salinas de Gortari (1988-1994).</li>
			<li>Regionalización en el contexto de la globalización.</li>
		</ol>
	</section>
	<section>
		<strong> RAP 2:</strong>
		<ol class="orderedlist">
			...
			<li>Gobierno de Felipe Calderón Hinojosa (2006-2012).</li>
			<li>Gobierno de Enrique Peña Nieto (2012-2018).</li>
		</ol>
	</section>
	...
	<ul class="orderedlist">
		...
		<li>
			<strong>Socialista:</strong> conformado por la Unión Soviética, Alemania Democrática, China, Vietna,
	...
	<ul class="orderedlist">
		...
		<li>
			La política económica cambió en todo el mundo y México tuvo que transitar hacia el
			neoliberalismo.
		</li>
		<li>
			El modelo de crecimiento hacia adentro dejó al país en bancarrota y se da el crecimiento hacia
			afuera.
		</li>
	...
	<ul class="orderedlist">
		...
		<li>
			Pacto de solaridad (PSE) proponía detener la inflación mediante la restricción de aumentos
			salariales y disminución de precios de la canasta básica.
		</li>
		<li>Desincorporación de empresas públicas.</li>
		<li>
			Adhesión de México al GATT (Acuerdo General sobre Aranceles Aduaneros y Comercio) y cambia
			nombre a OMC (Organización Mundial de Comercio)...
		</li>
	...
	<ul class="orderedlist">
		...
		<li>Dudas de legitimidad en elecciones presidenciales por la caida del sistema.</li>
		<li>
			Surge corriente democratizadora, se exigían métodos más democráticos para elegir a candidatos
			del partido.
		</li>
	...
	<ul class="orderedlist">
		...
		<li>
			Se deiblita el Corporativismo: El estado ya no inteviene como mediador y salvaguarda de los
			derechos obreros.
		</li>
	...
	<ul class="orderedlist">
		...
		<li>
			Artículo 27: promovió la extinción del "ejido", justo que los campesinos tuvieran propiedad de
			la tierras que cultivaban.
		</li>
		<li>Articulo 82: requisitos para aspirar a la presidencia de la república.</li>
		<li>
			Artículo 130: reconocimeinto de personalidad jurídica de la iglesia, miembros pueden opinar y
			votar.
		</li>
		<li>
			Se crea Programa Nacional de Solaridad (PRONASOL), que compromete el desarrollo de obras de
			infraestructura a la población, mientras que el Estado ponia una parte, la comunidad se
			comprometia con la mano de obra.
		</li>
		<li>
			Surge Grupo Compacto: jóvenes, tenía afamados estudios en prestigiadas universidades del
			extranjero y tendencia ideológica, neoliberalismo.
		</li>
		<li>Se privatiza la Banca en 1990.</li>
		<li>
			Creación del IFE, TFE, COFIPE, búsqueda de legitimidad en elecciones formadas por ciudadanos
			independientes.
		</li>
	</ul>
	...
	<p class="justificar samesubtopic">
		...
		de mercados financieros, innovación tecnológica e informática y la generalización de los
	...
	<ul class="orderedlist">
		...
		<li>
			Segunda: Unión Aduanera, la cual se expresa a través de un arancel común ante el resto del
			mundo.
		</li>
		<li>
			Tercera: Mercado Común, no se establece libertad en intercambio de bienes y servicios, libre
			movilidad de trabajo y capital. La expresión más avanzada del mercado común es unión económica
			donde existe una moneda común y la culminación de integración sería la integración total,
	...
	<p class="justificar samesubtopic">
		...
		por la comercialización de algunos rubros o eximiendo los impuestos. La integración se planteaba
		gradual y ascendente, pero no avanzó en la integración de personas, ni el tránsito de fronteras
	...
	<p class="justificar samesubtopic">
		...
		elite politica se enriquecen desproporcionalmente.
	</p>
	...
	<ul class="orderedlist">
		<li>
			...
			bancos no disponían de dinero. Se crea el FOBAPROA.
		</li>
		<li>
			<strong>FOBAPROA</strong>: El Fondo Bancario de Protección al Ahorro Bancario, creado para
			absorver las deudas ante los bancos y garantizar el dinero de los ahorradores.
		</li>
		<li>Efecto Tequila: la crisis afecta la economía de todas las naciones ligadas a México.</li>
	...
	<ul class="orderedlist">
		...
		<li>Reforma del poder Judicial Federal (Creación del Consejo de la Judicatura).</li>
		<li>Autonomía del IFE.</li>
	...
	<ul class="orderedlist">
		...
		<li>
			...
			Chiapas, donde irrumpieron en una pequeña iglesia donde indígenas tzotziles se encontraban
			orando, dejando a 45 muertos incluyendo niños y mujeres.
		</li>
		<li>
			Matanza de Aguas Blancas: campesinos del municipio Coyuca de Benítez en Guerrero, se
			dirigieron a un mítin político en protesta de un compañero desaparecido, acceso a agua y
			mejora en los servicios, donde posteriormente, fueron atacados por la policía del Estado.
		</li>
	</ul>
	...
	<ul class="orderedlist">
		...
		<li>Huelga UNAM: Rechazo al Aumento de Costos y Disminución de recursos educativos...</li>
	...
	<ul class="orderedlist">
		...
		<li>Disminuye déficit fiscal, control de inflación, crecimiento económico incipiente.</li>
	...
	<ul class="orderedlist">
		...
		<li>
			Crea "Programa y estrategias nacionales de seguridad" y el proyecto "Plataforma México" con la
			finalidad de llevar un sistema único criminal en el país.
		</li>
	</ul>
	<h4>Política Económica:</h4>
	<ul class="orderedlist">
		...
		<li>
			Pobreza crece y las condiciones económicas de más de la mitad de la población eran
			desfavorables.
		</li>
		<li>
			Inversiones favorecen la creación de infraestructura carretera, mantiene deuda pública
			estable.
		</li>
		<li>
	...
	<ul class="orderedlist">
		...
		<li>
			Pérdida de empleos por la quiebra de la empresa más grande de aviación, Mexicana de
			Aviación...
		</li>
		<li>...Entró en concurso mercantil que dejó a mas de 40 mil personas sin empleo.</li>
		<li>
			Promueve las Reformas Estructurales, apuntando a la privatización de actividades económicas
			del país.
		</li>
	</ul>
	...
	<ul class="orderedlist">
		...
		<li>
			Recursos económicos se desvían mediante proyectos como el tren suburbano, la estela de luz,
			convenios con Universidades que nunca se realizaron.
		</li>
		<li>
			Se promueve el Instituto Nacional de Evaluación Educativa (INEE), cuyo propósito solo fue
			contrarar más docentes, creando condiciones desfavorables, ignorando contratos colectivos y
			sin resultados favorables en ningún nivel educativo.
		</li>
		<li>
			Al menos, 41 dependencias y organismos del Gobierno Federal utilizaron a universidades y
			sistemas de televisión para desviar 9 mil 605 millones de pesos de recursos públicos, por
			medio del esquema conocido como "La Estafa Maestra".
		</li>
	</ul>
	...
	<ul class="orderedlist">
		...
		<li>
			...Asi lograron aprobar la Reforma Laboral, que prometía la creación de miles de nuevos
			empleos mediante el "outsourcing" o "subcontratación", permitiendo explotación laboral
			descarada.
		</li>
		<li>Reformas:</li>
		<li>Reforma Energética: con ella se permitió la inversión extranjera en la paraestatal.</li>
		<li>
			Reforma educativa: solo culpa de la crisis educativa a l@s docentes del país, sin invetir en
			la infraestructura educativa.
		</li>
		<li>
			"Reforma Hacendaria", gravó con impuestos a múltiples actividades y productos como compra
			benta de casas, transportes foráneos, etc, y creó un impuesto especial a los depósitos en
			efectivo.
		</li>
		<li>
			Caso Odebrecht: Ernesto Lozayo, titular de Pemex, recibió múltiples sobornos a cambio de
			contratos.
		</li>
		<li>
			"Avión Presidencial": gasto inmoral en un país con más de 60 millones de pobres cuyo valor se
			cotizaba como el avión presidencial más caro del mundo.
		</li>
	</ul>
	<h4>Política Social:</h4>
	<ul class="orderedlist">
		...
		<li>
			Compra de la "Casa Blanca" a grupo "HIGA" consorcio beneficiado por la administración de Peña
