...
<DefaultLayout title="Error en la página">
  <main class="mainpart">
    <article id="mainarticle">
      ...
      <h2>
        ¿Qué Puedes Hacer?
        <!--Dentro de este, iran los subitulos del contenido, ejemplo: "Exámenes parciales"-->
      </h2>
      <p class="justificar samesubtopic">
        Si crees que es un error favor de contactar a cualquiera de los
        creadores del sitio mostrados en la parte inferior.
      ...
      <p class="centrar">
        (Las páginas no mostradas siguen en desarrollo, pronto podrás
        consultarlas, agradecemos su comprensión y paciencia).
      </p>
    </article>
  </main>
</DefaultLayout>
